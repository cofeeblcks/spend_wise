...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="">
    ...
    <body class="min-h-screen bg-emphasis">
        ...
        <flux:footer>
            <div class="flex flex-col items-center justify-between py-3 px-8 mx-auto space-y-4 sm:space-y-0 sm:flex-row">
                ...
                <div class="flex -mx-2">
                    ...
                    <a href="https://www.linkedin.com/in/chavezhadik/" target="_blank" class="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-accent" aria-label="Github">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 fill-current" viewBox="0 0 24 24"><path fill="currentColor" d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zm-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.32 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93zM6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37z"/></svg>
                    </a>
                </div>
            </div>
        </flux:footer>
